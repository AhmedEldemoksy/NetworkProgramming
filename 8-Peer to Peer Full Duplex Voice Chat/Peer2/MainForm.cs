...
namespace VOIP
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // Peer_IP
            // 
            this.Peer_IP.Location = new System.Drawing.Point(144, 9);
            this.Peer_IP.Name = "Peer_IP";
            this.Peer_IP.Size = new System.Drawing.Size(163, 22);
            this.Peer_IP.TabIndex = 4;
            this.Peer_IP.Text = "10.0.0.20";
            // 
            // label1
            // 
            ...
            // button3
            // 
            this.button3.Location = new System.Drawing.Point(29, 46);
            ...
            // button4
            // 
            this.button4.Location = new System.Drawing.Point(192, 46);
            ...
            this.Text = "Peer 2 Full Duplex Voice Chat";
		...
		private void Voice_In()
		{
            ...
            {
                byte[] br;
                socket.Bind(new IPEndPoint(IPAddress.Any, 5030));
                while (true)
                {
                    br = new byte[16384];
                    socket.Receive(br);
		...
		private void Voice_Out(IntPtr data, int size)
		{
			...
			socket.SendTo(m_RecBuffer, new IPEndPoint(IPAddress.Parse(Peer_IP.Text),5020));
		}  
